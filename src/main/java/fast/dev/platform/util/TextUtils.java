...
public class TextUtils {
	...
	/* package */ static final char[] ELLIPSIS_TWO_DOTS = { '\u2025' }; // this
																		// is
																		// ".."
	 ...
	 * and control characters were trimmed from the start and end, as by
	 * {@link String#trim}.
	 */
	...
	public interface EllipsizeCallback {
		/**
		 * This method is called to report that the specified region of text was
		 * ellipsized away by a call to {@link #ellipsize}.
		 */
	...
	public static String htmlEncode(String s) {
		...
		for (int i = 0; i < s.length(); i++) {
			...
			case '\'':
				...
				// was introduced in
				// XML 1.0 but does not appear in HTML. Authors should therefore
				// use &#39; instead
	...
	/**
	 * Determine what caps mode should be in effect at the current offset in the
	 * text. Only the mode bits set in <var>reqModes</var> will be checked. Note
	 * that the caps mode flags here are explicitly defined to match those in
	 * {@link InputType}.
	 *
	 * @param cs
	 ...
	 *
	 * @return Returns the actual capitalization modes that can be in effect at
	 *         the current position, which is any combination of
	 *         {@link #CAP_MODE_CHARACTERS}, {@link #CAP_MODE_WORDS}, and
	 *         {@link #CAP_MODE_SENTENCES}.
	 */
